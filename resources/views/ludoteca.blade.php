...
<body>
    ...
    <section id="inicio">
        <div class="contenedor">
            <div class="texto">
                <h2>Bienvenido/a <br><br> a PlayGest</h2>
            </div>
            <img src="{{ asset('img/logoply.jpg.jpeg') }}" alt="imagen">
        </div>
    </section>
    ...
    <footer class="footer">
        <div class="footer-contenido">
            <div>
                <h4>About Us</h4>
                <p>Brenda Cardoso</p>
                <p>Uriel Solalíndez</p>
                <p>Alysone Velasco</p>
            </div>
        </div>
        <div class="footer-bottom">
            <p>© 2026 PlayGest. All rights reserved.</p>
        </div>
    </footer>
